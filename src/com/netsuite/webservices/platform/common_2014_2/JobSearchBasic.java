...
public class JobSearchBasic  extends com.netsuite.webservices.platform.core_2014_2.SearchRecordBasic  implements java.io.Serializable {
	...
	public String toString() {
		return "JobSearchBasic [accountNumber=" + accountNumber
				+ ", actualTime=" + actualTime + ", address=" + address
				+ ", addressee=" + addressee + ", addressLabel=" + addressLabel
				+ ", addressPhone=" + addressPhone
				+ ", allocatePayrollExpenses=" + allocatePayrollExpenses
				+ ", allowAllResourcesForTasks=" + allowAllResourcesForTasks
				+ ", allowExpenses=" + allowExpenses + ", allowTime="
				+ allowTime + ", applyProjectExpenseTypeToAll="
				+ applyProjectExpenseTypeToAll + ", attention=" + attention
				+ ", billingSchedule=" + Arrays.toString(billingSchedule)
				+ ", calculatedEndDate=" + calculatedEndDate
				+ ", calculatedEndDateBaseline=" + calculatedEndDateBaseline
				+ ", category=" + Arrays.toString(category) + ", city=" + city
				+ ", comments=" + comments + ", contact=" + contact
				+ ", country=" + Arrays.toString(country) + ", county="
				+ county + ", customer=" + Arrays.toString(customer)
				+ ", dateCreated=" + dateCreated + ", email=" + email
				+ ", endDate=" + endDate + ", entityId=" + entityId
				+ ", estCost=" + estCost + ", estEndDate=" + estEndDate
				+ ", estimatedGrossProfit=" + estimatedGrossProfit
				+ ", estimatedGrossProfitPercent="
				+ estimatedGrossProfitPercent + ", estimatedLaborCost="
				+ estimatedLaborCost + ", estimatedLaborCostBaseline="
				+ estimatedLaborCostBaseline + ", estimatedLaborRevenue="
				+ estimatedLaborRevenue + ", estimatedTime=" + estimatedTime
				+ ", estimatedTimeOverride=" + estimatedTimeOverride
				+ ", estimatedTimeOverrideBaseline="
				+ estimatedTimeOverrideBaseline + ", estRevenue=" + estRevenue
				+ ", externalId=" + Arrays.toString(externalId)
				+ ", externalIdString=" + externalIdString + ", fax=" + fax
				+ ", giveAccess=" + giveAccess + ", globalSubscriptionStatus="
				+ Arrays.toString(globalSubscriptionStatus) + ", image="
				+ image + ", includeCrmTasksInTotals="
				+ includeCrmTasksInTotals + ", internalId="
				+ Arrays.toString(internalId) + ", internalIdNumber="
				+ internalIdNumber + ", isDefaultBilling=" + isDefaultBilling
				+ ", isDefaultShipping=" + isDefaultShipping
				+ ", isExemptTime=" + isExemptTime + ", isInactive="
				+ isInactive + ", isProductiveTime=" + isProductiveTime
				+ ", isUtilizedTime=" + isUtilizedTime + ", jobBillingType="
				+ Arrays.toString(jobBillingType) + ", jobItem="
				+ Arrays.toString(jobItem) + ", jobPrice=" + jobPrice
				+ ", jobResource=" + Arrays.toString(jobResource)
				+ ", jobResourceRole=" + Arrays.toString(jobResourceRole)
				+ ", language=" + Arrays.toString(language)
				+ ", lastBaselineDate=" + lastBaselineDate
				+ ", lastModifiedDate=" + lastModifiedDate + ", level="
				+ Arrays.toString(level) + ", limitTimeToAssignees="
				+ limitTimeToAssignees + ", materializeTime=" + materializeTime
				+ ", parent=" + Arrays.toString(parent) + ", pctComplete="
				+ pctComplete + ", percentTimeComplete=" + percentTimeComplete
				+ ", permission=" + Arrays.toString(permission) + ", phone="
				+ phone + ", phoneticName=" + phoneticName
				+ ", projectedEndDateBaseline=" + projectedEndDateBaseline
				+ ", projectExpenseType=" + Arrays.toString(projectExpenseType)
				+ ", startDate=" + startDate + ", startDateBaseline="
				+ startDateBaseline + ", state=" + state + ", status="
				+ Arrays.toString(status) + ", subsidiary="
				+ Arrays.toString(subsidiary) + ", timeRemaining="
				+ timeRemaining + ", type=" + Arrays.toString(type)
				+ ", zipCode=" + zipCode + ", customFieldList="
				+ Arrays.toString(customFieldList) + ", __equalsCalc="
