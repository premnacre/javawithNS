...
public class JobSearch  extends com.netsuite.webservices.platform.core_2014_2.SearchRecord  implements java.io.Serializable {
	...
	public String toString() {
		return "JobSearch [basic=" + basic + ", billingScheduleJoin="
				+ billingScheduleJoin + ", contactPrimaryJoin="
				+ contactPrimaryJoin + ", customerJoin=" + customerJoin
				+ ", projectTaskJoin=" + projectTaskJoin
				+ ", resourceAllocationJoin=" + resourceAllocationJoin
				+ ", taskJoin=" + taskJoin + ", timeJoin=" + timeJoin
				+ ", customSearchJoin=" + Arrays.toString(customSearchJoin)
